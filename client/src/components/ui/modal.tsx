...
>(({ className, children, ...props }, ref) => (
  <ModalPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-darse-burhani-500 focus:ring-offset-2 disabled:pointer-events-none">
        <X className="h-4 w-4" />
