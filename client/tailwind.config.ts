...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        heading: ["'Plus Jakarta Sans'", "'Outfit'", "'Al-Kanz'", "system-ui", "-apple-system", "sans-serif"],
        display: ["'Plus Jakarta Sans'", "'Outfit'", "'Al-Kanz'", "system-ui", "-apple-system", "sans-serif"],
        info: ["'Inter'", "'DM Sans'", "'Al-Kanz'", "system-ui", "-apple-system", "sans-serif"],
        body: ["'Inter'", "'DM Sans'", "'Al-Kanz'", "system-ui", "-apple-system", "sans-serif"],
        sans: ["'Inter'", "'DM Sans'", "'Al-Kanz'", "system-ui", "-apple-system", "sans-serif"],
        error: ["'JetBrains Mono'", "'Space Grotesk'", "ui-monospace", "monospace"],
        alert: ["'JetBrains Mono'", "'Space Grotesk'", "ui-monospace", "monospace"],
